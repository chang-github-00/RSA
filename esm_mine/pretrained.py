...
def load_model_and_alphabet_core(model_data, regression_data=None):
    ...
    alphabet = esm_mine.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = esm_mine.ProteinBertModel
        ...
        model_type = esm_mine.MSATransformer

    elif "invariant_gvp" in model_data["args"].arch:
        model_type = msa.esm_mine.inverse_folding.gvp_transformer.GVPTransformerModel
